...
raw_t              = np.load("all_losses_t.npy")
raw_target         = np.load("all_losses_target.npy")
best_losses_t      = np.load("best_losses_t.npy")
best_losses_target = np.load("best_losses_target.npy")
...
print(f"best_losses_target shape: {best_losses_target.shape}")

assert best_losses_t.ndim == 1 and len(best_losses_t) == N_STEPS
assert best_losses_target.ndim == 1 and len(best_losses_target) == N_STEPS
